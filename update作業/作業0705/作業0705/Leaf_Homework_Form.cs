...
namespace 作業0705
{
    ...
    public partial class Leaf_Homework_Form : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            hw5_student_grade stu_grad = new hw5_student_grade();
            stu_grad.TopLevel = false;
            this.splitContainer1.Panel2.Controls.Add(stu_grad);
            stu_grad.Show();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            hw7_Simple_Calculator cal = new hw7_Simple_Calculator();
            cal.TopLevel = false;
            this.splitContainer1.Panel2.Controls.Add(cal);
            cal.Show();
        }

        private void button7_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://youtu.be/c_NuBJ3bKug");
